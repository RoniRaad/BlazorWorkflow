...
using BlazorFlow.Drawflow.BaseNodes;
...
namespace BlazorFlow.Helpers
{
    public static class DrawflowHelpers
    {
        ...
        public static async Task<int> CreateNodeV2(this BlazorFlowGraphBase dfBase, Node node, string symbol)
        {
            var inputHtml = "";
        ...
        public static async Task SetNodeStatus(this BlazorFlowGraphBase dfBase, string nodeId, NodeStatus nodeStatus)
        {

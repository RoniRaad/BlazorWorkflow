...
using static BlazorFlow.Models.DTOs.DfExport;
...
public partial class BlazorFlowGraphBase : ComponentBase, IAsyncDisposable
{
    private DotNetObjectReference<BlazorFlowGraphBase>? _selfRef;
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        if (firstRender)
        {
            ...
            // Create the wrapper:
            Editor = new BlazorFlow.Drawflow.DrawflowEditor(
    ...
    public BlazorFlow.Drawflow.DrawflowEditor? Editor { get; set; }
